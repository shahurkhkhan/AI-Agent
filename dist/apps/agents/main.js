...
var TodoRepository = function TodoRepository(todoModel) {
    ...
    this.isValidMongoId = function(id) {
        return external_mongodb_namespaceObject.ObjectId.isValid(id) && String(new external_mongodb_namespaceObject.ObjectId(id)) === id;
    };
    ...
    this.findById = function(id) {
        return todo_repository_async_to_generator(function() {
            return todo_repository_ts_generator(this, function(_state) {
                return [
                    2,
                    this.todoModel.findById(id).lean().exec()
                ];
            });
        }).call(_this);
    };
    ...
    this.updateTodo = function(id, payload) {
        return todo_repository_async_to_generator(function() {
            return todo_repository_ts_generator(this, function(_state) {
                return [
                    2,
                    this.todoModel.findByIdAndUpdate(id, payload, {
...
var DeleteTodoTool = /*#__PURE__*/ function() {
    ...
    function DeleteTodoTool(todoRepository) {
        ...
        this.schema = external_zod_namespaceObject.z.object({
            id: external_zod_namespaceObject.z.string().regex(/^[a-f\d]{24}$/i, 'Invalid Mongo ObjectId')
        });
        this.func = function(param) {
            ...
            return delete_todo_tool_async_to_generator(function() {
                ...
                return delete_todo_tool_ts_generator(this, function(_state) {
                    todo = this.todoRepository.isValidMongoId(id);
...
;// ../../libs/todo-agent/src/lib/agent/tools/update-todo.tool.ts
function update_todo_tool_asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {
    try {
        var info = gen[key](arg);
        var value = info.value;
    } catch (error) {
...
function update_todo_tool_async_to_generator(fn) {
    return function() {
        var self = this, args = arguments;
        return new Promise(function(resolve, reject) {
            var gen = fn.apply(self, args);
            function _next(value) {
                update_todo_tool_asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);
            }
            function _throw(err) {
                update_todo_tool_asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);
            }
            _next(undefined);
        });
    };
}
function update_todo_tool_ts_decorate(decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for(var i = decorators.length - 1; i >= 0; i--)if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    return c > 3 && r && Object.defineProperty(target, key, r), r;
}
function update_todo_tool_ts_generator(thisArg, body) {
    var f, y, t, _ = {
        label: 0,
        sent: function() {
            if (t[0] & 1) throw t[1];
...
function update_todo_tool_ts_metadata(k, v) {
    if (typeof Reflect === "object" && typeof Reflect.metadata === "function") return Reflect.metadata(k, v);
}
...
var UpdateTodoTool = /*#__PURE__*/ function() {
    "use strict";
    function UpdateTodoTool(todoRepository) {
        var _this = this;
        this.todoRepository = todoRepository;
        ...
        this.schema = external_zod_namespaceObject.z.object({
            id: external_zod_namespaceObject.z.string().regex(/^[a-f\d]{24}$/i, 'Invalid Mongo ObjectId'),
            task: external_zod_namespaceObject.z.string().optional(),
            priority: external_zod_namespaceObject.z.enum([
                'low',
                'medium',
                'high'
            ]).optional(),
            isCompleted: external_zod_namespaceObject.z.boolean().optional(),
            updatedAt: external_zod_namespaceObject.z.string().optional()
        });
        this.func = function(param) {
            var id = param.id, task = param.task, priority = param.priority, isCompleted = param.isCompleted;
            return update_todo_tool_async_to_generator(function() {
                var todoId, todo, updatePayload;
                return update_todo_tool_ts_generator(this, function(_state) {
                    switch(_state.label){
                        case 0:
                            todoId = this.todoRepository.isValidMongoId(id);
                            if (!todoId) {
                                return [
                                    2,
                                    "Todo Id is not valid"
                        ...
                        case 1:
                            ...
                            return [
                                2,
                                this.todoRepository.updateTodo(id, updatePayload)
                            ];
                    }
                });
            }).call(_this);
    ...
    var _proto = UpdateTodoTool.prototype;
    _proto.getTool = function getTool() {
        return new tools_namespaceObject.DynamicStructuredTool({
            name: this.name,
            description: this.description,
...
UpdateTodoTool = update_todo_tool_ts_decorate([
    (0,common_namespaceObject.Injectable)(),
    update_todo_tool_ts_metadata("design:type", Function),
    update_todo_tool_ts_metadata("design:paramtypes", [
        typeof TodoRepository === "undefined" ? Object : TodoRepository
    ])
], UpdateTodoTool);
...
var ToolRegistry = /*#__PURE__*/ function() {
    "use strict";
    function ToolRegistry(createTodoTool, listTodoTool, deleteTodoTool, searchTodoTool, updateTodoTool) {
        var _this = this;
        ...
        this.updateTodoTool = updateTodoTool;
...
ToolRegistry = tool_registry_ts_decorate([
    ...
    tool_registry_ts_metadata("design:paramtypes", [
        ...
        typeof UpdateTodoTool === "undefined" ? Object : UpdateTodoTool
    ])
], ToolRegistry);
...
var ToolNode = function ToolNode(toolRegistry) {
    ...
    this.execute = function(state) {
        return tool_node_async_to_generator(function() {
            var _lastMessage_tool_calls, lastMessage, toolCalls, toolMessages, _iterator, _step, call, tool, observation, error;
...
var AgentState = new langgraph_namespaceObject.StateSchema({
    ...
    error: v4_namespaceObject.z.string()
});
...
var ChatGraph = /*#__PURE__*/ function() {
    "use strict";
    function ChatGraph(llmNode, memoryNode, toolNode) {
    ...
    _proto.build = function build() {
        ...
        //     .addEdge('toolNode', 'llmNode')
        //     .compile();
        return new langgraph_namespaceObject.StateGraph(AgentState).addNode('memoryGet', this.memoryNode.get).addNode('llmNode', this.llmNode.execute).addNode('toolNode', this.toolNode.execute).addNode('memoryUpdate', this.memoryNode.update).addEdge(langgraph_namespaceObject.START, 'memoryGet').addEdge('memoryGet', 'llmNode').addConditionalEdges('llmNode', this.shouldContinue, {
            toolNode: 'toolNode',
            memoryUpdate: 'memoryUpdate'
        }).addEdge('toolNode', 'llmNode').addEdge('memoryUpdate', langgraph_namespaceObject.END).compile();
    };
    return ChatGraph;
}();
